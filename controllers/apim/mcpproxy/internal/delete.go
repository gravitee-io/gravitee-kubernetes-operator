...
func Delete(ctx context.Context, proxy *v1alpha1.McpProxy) error {
	if !util.ContainsFinalizer(proxy, core.McpProxyFinalizer) {
		return nil
	}
	...
	if err := gerrors.IgnoreNotFound(apimClient.McpProxies.Delete(proxy)); err != nil {
