...
func Delete(ctx context.Context, idpgroupmapping *v1alpha1.IDPGroupMapping) error {
	...
	// Check if the group mapping exists, if yes, remove it from the configuration
	...
	// Step 3, generate a new group mapping configuration without the group mapping to delete
	...
	// Step 4, Update the IDP configuration with the new group mapping configuration
