...
func Delete(ctx context.Context, srv *v1alpha1.CatalogMcpServer) error {
	if !util.ContainsFinalizer(srv, core.CatalogMcpServerFinalizer) {
		return nil
	}
	...
	if err := gerrors.IgnoreNotFound(apimClient.CatalogMcpServers.Delete(srv)); err != nil {
