...
image:https://circleci.com/gh/gravitee-io/gravitee-kubernetes-operator/tree/master.svg?style=svg[link="https://app.circleci.com/pipelines/github/gravitee-io/gravitee-kubernetes-operator?branch=master"]
