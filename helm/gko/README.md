...
| `manager.pod.securityContext`                                    | Specifies the security context that will apply to all containers running within the pod                                                                                                                                                                                                                         | `{}`                                    |
| `manager.pod.nodeSelector`                                       | Specifies a set of labels to be used to select on which node the manager pod should be scheduled.                                                                                                                                                                                                               | `{}`                                    |
| `manager.container.securityContext`                              | Specifies the security context that will apply to the controller manager container.                                                                                                                                                                                                                             | `{}`                                    |
...
| `manager.httpClient.timeoutSeconds`                              | the timeout (in seconds) used when issuing request to the Management API.                                                                                                                                                                                                                                       | `5`                                     |
| `manager.httpClient.proxy.enabled`                               | If true, GKO will use your proxy when making any external call                                                                                                                                                                                                                                                  | `false`                                 |
| `manager.httpClient.proxy.useSystemProxy`                        | If true, GKO will use your pre-defined env HTTP_PROXY, HTTPS_PROXY and NO_PROXY (or the lowercase versions)                                                                                                                                                                                                     | `false`                                 |
| `manager.httpClient.proxy.url`                                   | The proxy url eg: http://localhost:8080 or socks5://localhost:1080                                                                                                                                                                                                                                              | `""`                                    |
...
| `manager.httpClient.trustStore.path`                             | The path to the mounted truststore (in pem format), if you mount your certificate inside the default "/etc/ssl/certs" folder then you don't need to set this parameter                                                                                                                                          | `""`                                    |
...
| `manager.webhook.service.port`                                   | The port exposed by the webhook Service.                                                                                                                                                                                                                                                                        | `443`                                   |
| `manager.webhook.service.targetPort`                             | The port the webhook server listens on.                                                                                                                                                                                                                                                                         | `9443`                                  |
...
| `manager.webhook.admission.checkApiContextPathConflictInCluster` | If true, the admission controller will check in the whole cluster if an API exists with the same context path and reject the request if it does. If false, the admission controller will only check in the namespace of the API being validated.                                                                | `false`                                 |
