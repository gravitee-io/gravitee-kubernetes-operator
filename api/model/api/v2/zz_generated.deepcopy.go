...
func (in *Api) DeepCopyInto(out *Api) {
	*out = *in
	...
	if in.ConsoleNotification != nil {
		...
		*out = new(base.ConsoleNotificationConfiguration)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *Page) DeepCopyInto(out *Page) {
	*out = *in
	...
	if in.AccessControls != nil {
		...
		*out = make([]base.AccessControl, len(*in))
		copy(*out, *in)
	}
	if in.ExcludedAccessControl != nil {
		in, out := &in.ExcludedAccessControl, &out.ExcludedAccessControl
		*out = new(bool)
		**out = **in
	}
}
...
func (in *Proxy) DeepCopyInto(out *Proxy) {
	*out = *in
	...
	if in.StripContextPath != nil {
		in, out := &in.StripContextPath, &out.StripContextPath
		*out = new(bool)
		**out = **in
	}
