...
func (in *HttpClientOptions) DeepCopyInto(out *HttpClientOptions) {
	*out = *in
	...
	if in.MaxChunkSize != nil {
		in, out := &in.MaxChunkSize, &out.MaxChunkSize
		*out = new(int)
		**out = **in
	}
	if in.MaxWaitQueueSize != nil {
		in, out := &in.MaxWaitQueueSize, &out.MaxWaitQueueSize
		*out = new(int)
		**out = **in
	}
...
func (in *Page) DeepCopyInto(out *Page) {
	*out = *in
	...
	if in.ParentHRID != nil {
		in, out := &in.ParentHRID, &out.ParentHRID
		*out = new(string)
		**out = **in
	}
	if in.API != nil {
