...
type ApiStatus struct {
	...
	// UseHRID In an ideal world, tests should never use IDs
	// But at the moment it is using IDs to fetch and assert data from
	// management API. So this boolean indicate that when calling the API
	// IDs that are used are HRID. It also means that IDs in the status were generated by Automation API.
