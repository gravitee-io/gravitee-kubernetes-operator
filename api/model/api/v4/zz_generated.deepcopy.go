...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutomationApi) DeepCopyInto(out *AutomationApi) {
	*out = *in
	if in.V4BaseApi != nil {
		in, out := &in.V4BaseApi, &out.V4BaseApi
		*out = new(V4BaseApi)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutomationApi.
func (in *AutomationApi) DeepCopy() *AutomationApi {
	if in == nil {
		return nil
	}
	out := new(AutomationApi)
	in.DeepCopyInto(out)
	return out
}
