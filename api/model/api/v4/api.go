...
// +kubebuilder:validation:Enum=PROXY;MESSAGE;NATIVE;LLM_PROXY;MCP_PROXY;
type ApiType string
...
type Api struct {
	*base.ApiBase `json:",inline"`
	...
	// API life cycle state can be one of the values PUBLISHED, UNPUBLISHED, DEPRECATED, ARCHIVED
