...
type Status struct {
	// The ID of the Portal in the Gravitee API Management instance
	...
	// Conditions describe the current conditions of the Portal.
	//
	...
	// When portal has been created regardless of errors, this field is
