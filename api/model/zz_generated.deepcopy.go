	...
	*out = *in
	...
	if in.ApplicationMetaData != nil {
		...
		*out = new([]ApplicationMetaData)
		if **in != nil {
			in, out := *in, *out
			*out = make([]ApplicationMetaData, len(*in))
			for i := range *in {
				(*in)[i].DeepCopyInto(&(*out)[i])
			}
		}
...
func (in *ApplicationMetaData) DeepCopyInto(out *ApplicationMetaData) {
	*out = *in
	if in.Format != nil {
		...
		*out = new(ApplicationMetaDataFormat)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApplicationSetting) DeepCopyInto(out *ApplicationSetting) {
	*out = *in
	if in.App != nil {
		in, out := &in.App, &out.App
		*out = new(SimpleApplicationSettings)
		**out = **in
	}
	if in.Oauth != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApplicationSetting.
func (in *ApplicationSetting) DeepCopy() *ApplicationSetting {
	if in == nil {
		return nil
	}
	out := new(ApplicationSetting)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SimpleApplicationSettings) DeepCopyInto(out *SimpleApplicationSettings) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SimpleApplicationSettings.
func (in *SimpleApplicationSettings) DeepCopy() *SimpleApplicationSettings {
	if in == nil {
		return nil
	}
	out := new(SimpleApplicationSettings)
