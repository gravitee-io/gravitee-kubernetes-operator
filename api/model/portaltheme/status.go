...
type Status struct {
	// The ID of the PortalTheme in the Gravitee API Management instance
	...
	// Conditions describe the current conditions of the PortalTheme.
	//
	...
	// When theme has been created regardless of errors, this field is
