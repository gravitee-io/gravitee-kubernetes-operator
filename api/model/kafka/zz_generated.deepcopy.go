...
func (in *KafkaACLFilter) DeepCopyInto(out *KafkaACLFilter) {
	*out = *in
	if in.Rules != nil {
		...
		*out = make([]KafkaAccessControlRules, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KafkaAccessControlRules) DeepCopyInto(out *KafkaAccessControlRules) {
	*out = *in
	if in.Resources != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaAccessControlRules.
func (in *KafkaAccessControlRules) DeepCopy() *KafkaAccessControlRules {
	if in == nil {
		return nil
	}
	out := new(KafkaAccessControlRules)
	in.DeepCopyInto(out)
	return out
}
