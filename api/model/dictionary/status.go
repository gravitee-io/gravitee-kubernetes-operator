...
type Status struct {
	// The ID of the Dictionary in the Gravitee API Management instance
	...
	// Conditions describe the current conditions of the Dictionary.
	//
	...
	// When dictionary has been created regardless of errors, this field is
