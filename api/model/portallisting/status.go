...
type Status struct {
	// The ID of the PortalListing in the Gravitee API Management instance
	...
	// Conditions describe the current conditions of the PortalListing.
	//
	...
	// When the portal listing has been created regardless of errors, this field
	// is used to persist the error message encountered during admission
