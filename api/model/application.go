...
type ApplicationKeyMode string
...
type ApplicationMetaDataFormat string
...
type ApplicationMetaData struct {
	...
	Format        *ApplicationMetaDataFormat `json:"format,omitempty"`
...
type Application struct {
	...
	Metadata        *GenericStringMap `json:"metadata,omitempty"`
	...
	AppKeyMode                     *ApplicationKeyMode    `json:"app_key_mode,omitempty"`
