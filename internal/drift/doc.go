...
//   - empty-is-nil (slice, map): same length is equivalent at the container level;
//     item-level comparison continues unless lengths differ ([CannotCompare]).
...
//   - structs: [Inequivalent] with skip when exactly one side is nil; otherwise
