...
const (
	...
	ApiV4SharedPolicyGroupsField IndexField = "api-v4-sgp"
...
func InitCache(ctx context.Context, cache cache.Cache) error {
	...
	apiV4SharedPolicyGroupsIndexer := newIndexer(ApiV4SharedPolicyGroupsField, indexIApiV4FlowsSharedPolicyGroupsRefs)
...
func indexIApiV4FlowsSharedPolicyGroupsRefs(api *v1alpha1.ApiV4Definition, fields *[]string) {
	sharedPolicyGroups := api.GetAllSharedPolicyGroups()

	for _, sharedPolicyGroup := range sharedPolicyGroups {
