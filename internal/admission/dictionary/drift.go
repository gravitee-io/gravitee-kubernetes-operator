...
func validateUpdate(ctx context.Context, oldObj runtime.Object, newObj runtime.Object) *errors.AdmissionErrors {
	...
	oldDict, _ := oldObj.(*v1alpha1.Dictionary)
	newDict, _ := newObj.(*v1alpha1.Dictionary)
...
func getRemoteDictionary(apimClient *apim.APIM, o runtime.Object, errs *errors.AdmissionErrors) any {
	dict, _ := o.(*v1alpha1.Dictionary)
