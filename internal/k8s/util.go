...
func HaveGrantedReference(ctx context.Context, from client.Object, to gwAPIv1.ObjectReference) (bool, error) {
	if to.Namespace != nil && from.GetNamespace() != string(*to.Namespace) {
		return true, nil
	}
