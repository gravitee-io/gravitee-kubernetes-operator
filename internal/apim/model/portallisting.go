...
type PortalListingDTO struct {
	...
	APIs []PortalListingApiEntryDTO `json:"apis,omitempty"`
}

type PortalListingApiEntryDTO struct {
...
type PortalListingState struct {
	PortalListingDTO     `json:",omitempty"`
	portallisting.Status `json:",omitempty"`
}
