...
var _ = Describe("Validate drift for PROXY APIs", labels.WithContext, func() {
	...
	It("should not drift with unset defaulted fields", func() {
		fixtures := fixture.Builder().
			WithAPIv4(constants.ApiV4ProxyDriftDefaultsFile).
			WithContext(constants.ContextWithCredentialsFile).
			Build().
			Apply()
	...
	It("should detect drift with unset defaulted fields", func() {
		fixtures := fixture.Builder().
			WithAPIv4(constants.ApiV4ProxyDriftDefaultsFile).
			WithContext(constants.ContextWithCredentialsFile).
			Build().
