...
var _ = Describe("Validate create", labels.WithContext, func() {
	...
	fixtures.Subscription.Spec.App.Name = "unresolved"
	fixtures.Subscription.Namespace = constants.Namespace

	fixtures.Apply()

	It("should fail with unresolvable application reference", func() {
		...
		Eventually(func() error {
			...
			return assert.Equals("error", errors.NewSevere("unable to resolve application [default/unresolved]"), err)
