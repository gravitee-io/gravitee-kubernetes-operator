...
var _ = Describe("Validate create", labels.WithContext, func() {
	...
	fixtures.Subscription.Spec.Plan = "unresolved"
	fixtures.Subscription.Namespace = constants.Namespace

	It("should fail with unresolvable plan reference", func() {
		...
		Eventually(func() error {
			...
			return assert.Equals(
				"error",
				errors.NewSeveref(
					"unable to subscribe to API [%s] because plan [unresolved] cannot be found",
