...
var _ = Describe("Validate drift", labels.WithContext, func() {
	...
	It("should not drift on a simple update", func() {
		...
		newSpg.Spec.Description = new("updated description")
	...
	It("should detect drift", func() {
		...
		newSpg.Spec.Description = new("remote updated description")
		...
		newSpg.Spec.Description = new("local CRD description")
