...
var _ = Describe("Validate create", labels.WithContext, func() {
	...
	It("should return no error", func() {
		...
		By("having an invalid RESPONSE phase with RateLimit policy")
		...
		fixtures2.SharedPolicyGroup.Spec.Phase = (*policygroups.FlowPhase)(utils.ToReference("RESPONSE"))
		...
		Eventually(func() error {
			...
			return assert.Equals(
				"error",
				errors.NewSevere(
					"Unexpected policies [Rate Limit] for API type PROXY and phase RESPONSE",
				),
				err,
			)
