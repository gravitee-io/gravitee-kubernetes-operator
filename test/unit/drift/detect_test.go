  ...
  x[0]:
    ...
    order: <nil> != 66`)
			...
			It(" detect map of struct arrays drift, missing crd item", func() {
				...
				remote := withMapOfStructArray{Name: ptr("test"), Values: map[string][]MultipleWithPtr{"x": {
					{Name: ptr("foo"), Order: ptr(66)},
					{Name: ptr("foo"), Order: ptr(66)},
				}}}
				expectDrift(drift.DetectWithNamespace(crd, remote, ""), `values:
			...
			It("detects map drift, complete remote nil", func() {
				crd := withUnstructured{
					...
					Config: unstructured.Unstructured{Object: map[string]interface{}{
						...
						"struct":               map[string]SingleWithPtr{"response": {Value: ptr("42")}},
						"int_array":            map[string][]int{"response": {42}},
						"string_array":         map[string][]string{"response": {"42"}},
						"struct_array":         map[string][]SingleWithPtr{"response": {{Value: ptr("42")}}},
						...
						"map_struct_array":     map[string]map[string][]SingleWithPtr{"response": {"it": {{Value: ptr("42")}}}},
  ...
  timeout: "5s" != map[unit:ms value:5000]`)
	...
	Describe("when no drift is detected", func() {
		...
		DescribeTable("equivalent values",
			...
			Entry("struct with struct array, equivalents",
				withPointerStructArray{Name: nil, Values: []*MultipleWithPtr{{Name: ptr(""), Order: ptr(0)}, {Name: nil, Order: nil}}},
				withPointerStructArray{Name: ptr(""), Values: []*MultipleWithPtr{{Name: nil}, {Name: ptr(""), Order: ptr(0)}}},
			),
			...
			Entry("struct with map of struct, equal",
				withMapOfArray{Name: ptr("test"), Values: map[string][]int{"y": {1}}},
				withMapOfArray{Name: ptr("test"), Values: map[string][]int{"y": {1}}},
			),
			Entry("struct with map of array, equal",
	...
	Describe("when invalid inputs cause panic", func() {
		...
		It("panics when registering an equivalence for pointer kind", func() {
			Expect(func() {
				drift.RegisterEquivalenceFunc("pointer-kind", reflect.Pointer, drift.FromDeepEqual)
		...
		It("panics when comparing values of different types through a registered equivalence", func() {
			drift.RegisterEquivalenceFunc("type-check-panic", reflect.Interface, drift.FromDeepEqual)
...
var _ = Describe("Merge", func() {
	...
	DescribeTable("no drift",
		...
		Entry("case 2 maps array varies, result tree do not have the same structure",
			withMapOfArray{Name: ptr("test"), Values: map[string][]int{"x": {0}, "y": {66}, "z": {12}}},
			withMapOfArray{Name: ptr("test"), Values: map[string][]int{"x": {42, 43}, "y": {66, 67}, "z": {12}}},
			withMapOfArray{Name: ptr("test"), Values: map[string][]int{"x": {42, 43}, "y": {66, 67}, "z": {12}}},
		),
		Entry("case 2, result trees do not have the same structure",
			withStructArray{Name: ptr("test"), Values: []MultipleWithPtr{{Name: ptr("foo"), Order: ptr(66)}, {Name: ptr("bar"), Order: ptr(42)}}},
			withStructArray{Name: ptr("test"), Values: []MultipleWithPtr{{Name: ptr("foo"), Order: ptr(66)}}},
			withStructArray{Name: ptr("test"), Values: []MultipleWithPtr{{Name: ptr("foo"), Order: ptr(66)}}},
		),
		Entry("case 2, result trees do not have the same structure",
			withPointerStructArray{
				Name: ptr("test"), Values: []*MultipleWithPtr{
					{Name: ptr("foo"), Order: ptr(66)},
					{Name: ptr("bar"), Order: ptr(42)}},
			},
			withPointerStructArray{Name: ptr("test"), Values: []*MultipleWithPtr{{Name: ptr("foo"), Order: ptr(66)}}},
			withPointerStructArray{Name: ptr("test"), Values: []*MultipleWithPtr{{Name: ptr("foo"), Order: ptr(66)}}},
		),
		...
		Entry("case 4 maps, result tree do not have the same structure",
			withMapOfArray{Name: ptr("test"), Values: map[string][]int{"x": {0}}},
			withMapOfArray{Name: ptr("test"), Values: map[string][]int{"x": {42}, "y": {66}, "z": {12}}},
			withMapOfArray{Name: ptr("test"), Values: map[string][]int{"x": {0}}},
		),
		...
		Entry("case 4 map key rename without remote change",
			withMapOfPrimitive{Values: map[string]*int{"a": ptr(1)}},
			withMapOfPrimitive{Values: map[string]*int{"c": ptr(1)}},
			withMapOfPrimitive{Values: map[string]*int{"b": ptr(1)}},
		),
	)
  ...
  y[1]: 0 != 67`,
		...
		Entry("case 3 maps, result trees do not have the same structure",
			withMapOfArray{Name: ptr("test"), Values: map[string][]int{"w": {1}, "x": {0}, "y": {66}}},
			withMapOfArray{Name: ptr("test"), Values: map[string][]int{"w": {1}, "x": {42}, "y": {66}, "z": {12}}},
			withMapOfArray{Name: ptr("test"), Values: map[string][]int{"x": {42}, "y": {66, 67}, "z": {12}}},
			`values:
  w[0]: 1 != 0
  y[1]: 0 != 67`,
