...
var _ = Describe("HttpClientOptions pool fields", func() {
	Context("JSON serialization", func() {
		It("omits maxWaitQueueSize when nil (preserves APIM default of -1)", func() {
	...
	Context("JSON deserialization", func() {
		It("leaves maxWaitQueueSize nil when absent from JSON", func() {
	...
	Context("round-trip", func() {
		It("preserves explicit value through marshal/unmarshal", func() {
			queueSize := 100
