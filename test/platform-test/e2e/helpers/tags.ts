...
export const XRAY = {
  ...
  SUBSCRIPTIONS: {
    ...
    V4_APIKEY_CUSTOM_KEY: "@GKO-TBD-V4-APIKEY-CUSTOM-KEY",
    V4_APIKEY_LENGTH_REJECTED: "@GKO-TBD-V4-APIKEY-LENGTH-REJECTED",
    V4_APIKEY_LENGTH_BOUNDARIES: "@GKO-TBD-V4-APIKEY-LENGTH-BOUNDARIES",
    V4_APIKEY_EXPIRE_AT: "@GKO-TBD-V4-APIKEY-EXPIRE-AT",
    V4_APIKEY_SECRET_SOURCED: "@GKO-TBD-V4-APIKEY-SECRET-SOURCED",
    V4_APIKEY_ROTATION_INSTANT: "@GKO-TBD-V4-APIKEY-ROTATION-INSTANT",
    V4_APIKEY_ROTATION_GRADUAL: "@GKO-TBD-V4-APIKEY-ROTATION-GRADUAL",
    V4_APIKEY_REACTIVATION: "@GKO-TBD-V4-APIKEY-REACTIVATION",
    V4_APIKEY_IDEMPOTENT: "@GKO-TBD-V4-APIKEY-IDEMPOTENT",
  ...
  TERRAFORM: {
    ...
    // Tags are placeholders until the corresponding Xray tickets are filed.
    APIKEY_AUTO_GENERATED: "@GKO-TBD-TF-APIKEY-AUTO-GENERATED",
    APIKEY_CUSTOM_VALUE: "@GKO-TBD-TF-APIKEY-CUSTOM-VALUE",
    APIKEY_EXPIRE_AT: "@GKO-TBD-TF-APIKEY-EXPIRE-AT",
    APIKEY_MIXED_WITH_KEYLESS: "@GKO-TBD-TF-APIKEY-MIXED-WITH-KEYLESS",
    APIKEY_LENGTH_BOUNDARIES: "@GKO-TBD-TF-APIKEY-LENGTH-BOUNDARIES",
    APIKEY_LENGTH_REJECTED: "@GKO-TBD-TF-APIKEY-LENGTH-REJECTED",
    APIKEY_ROTATION_INSTANT: "@GKO-TBD-TF-APIKEY-ROTATION-INSTANT",
    APIKEY_ROTATION_GRADUAL: "@GKO-TBD-TF-APIKEY-ROTATION-GRADUAL",
    APIKEY_REACTIVATION: "@GKO-TBD-TF-APIKEY-REACTIVATION",
    APIKEY_STAGGERED_EXPIRY: "@GKO-TBD-TF-APIKEY-STAGGERED-EXPIRY",
    APIKEY_REVOKED_ON_DESTROY: "@GKO-TBD-TF-APIKEY-REVOKED-ON-DESTROY",
    APIKEY_PLAN_NO_DRIFT: "@GKO-TBD-TF-APIKEY-PLAN-NO-DRIFT",
    APIKEY_SENSITIVE_IN_PLAN: "@GKO-TBD-TF-APIKEY-SENSITIVE-IN-PLAN",
    // ── GKO-2564: apim_group resource + data source ────────────────
    // Built on GKO-2551 (Automation API group endpoints). Tags are
    // placeholders until the corresponding Xray tickets are filed.
    GROUP_CREATE: "@GKO-TBD-TF-GROUP-CREATE",
    GROUP_IDEMPOTENT: "@GKO-TBD-TF-GROUP-IDEMPOTENT",
    GROUP_UPDATE: "@GKO-TBD-TF-GROUP-UPDATE",
    GROUP_NOTIFY_MEMBERS: "@GKO-TBD-TF-GROUP-NOTIFY-MEMBERS",
    GROUP_DESTROY: "@GKO-TBD-TF-GROUP-DESTROY",
    GROUP_WITH_MEMBER: "@GKO-TBD-TF-GROUP-WITH-MEMBER",
    GROUP_MEMBER_LIFECYCLE: "@GKO-TBD-TF-GROUP-MEMBER-LIFECYCLE",
    GROUP_MEMBERS_IDEMPOTENT: "@GKO-TBD-TF-GROUP-MEMBERS-IDEMPOTENT",
    GROUP_HRID_REPLACEMENT: "@GKO-TBD-TF-GROUP-HRID-REPLACEMENT",
    GROUP_DRIFT: "@GKO-TBD-TF-GROUP-DRIFT",
    GROUP_IMPORT: "@GKO-TBD-TF-GROUP-IMPORT",
    GROUP_INVALID_HRID: "@GKO-TBD-TF-GROUP-INVALID-HRID",
    GROUP_INVALID_NAME: "@GKO-TBD-TF-GROUP-INVALID-NAME",
    GROUP_DATA_SOURCE: "@GKO-TBD-TF-GROUP-DATA-SOURCE",
  },
  PAGES: {
