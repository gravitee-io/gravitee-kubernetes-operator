...
**As an API producer, I define a shared policy group once and reuse it across an API.**

The SPG injects `X-SPG-Test`, which the echo endpoint reflects, proving the SPG
runs at the gateway.
