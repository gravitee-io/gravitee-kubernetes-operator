 ...
 * tests/user-journeys/api-consumer/register-and-retire-application (its Terraform arm).
 *
...
test.describe(`Terraform — subscription errors & app delete ${PROVISIONER.TERRAFORM}`, () => {
  ...
  // Terraform arm of tests/user-journeys/api-consumer/register-and-retire-application.
});
