 ...
 * cross-provisioner journey tests/user-journeys/api-producer/secure-api-with-plan — both plan
...
test.describe(`Plans — Security Types ${PROVISIONER.GKO}`, () => {
  ...
  // cross-provisioner journey tests/user-journeys/api-producer/secure-api-with-plan.
