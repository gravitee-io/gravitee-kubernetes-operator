...
| `followRedirects` _boolean_ | Should HTTP redirects be followed or not ? |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `trustAll` _boolean_ | Whether to trust all issuers or not (default: false) |  |  |
| `hostnameVerifier` _boolean_ | Verify Hostname when establishing connection |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `enabled` _boolean_ | Specifies that the HTTP connection will be established through a proxy (default: false) |  |  |
| `useSystemProxy` _boolean_ | If true, the proxy defined at the system level will be used (default: false) |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `enabled` _boolean_ | Is resource enabled or not? (default: true) |  | Optional: \{\} <br /> |
...
| `enabled` _boolean_ | Indicate if this flow is enabled or disabled (default: true) |  |  |
...
| `enabled` _boolean_ | Is service enabled or not? (default: false) |  | Optional: \{\} <br /> |
...
| `name` _string_ | Flow name |  | Optional: \{\} <br /> |
| `enabled` _boolean_ | Is flow enabled or not? (default: true) |  |  |
...
| `definitionVersion` _[DefinitionVersion](#definitionversion)_ | Plan definition version (default: V4) |  |  |
