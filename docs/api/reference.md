...
| `type` _[ApiType](#apitype)_ | Api Type (proxy or message) |  | Enum: [PROXY MESSAGE NATIVE LLM_PROXY MCP_PROXY] <br />Required: \{\} <br /> |
...
_Validation:_
- Enum: [PROXY MESSAGE NATIVE LLM_PROXY MCP_PROXY]
