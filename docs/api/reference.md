...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `gravitee` _[GraviteeConfig](#graviteeconfig)_ |  |  | Optional: \{\} <br /> |
| `kubernetes` _[KubernetesConfig](#kubernetesconfig)_ |  |  | Optional: \{\} <br /> |
...
| `hostname` _[Hostname](#hostname)_ | We do not accept the route in our case if hostname is not set (for now) |  | MaxLength: 253 <br />MinLength: 1 <br />Pattern: `^(\*\.)?[a-z0-9]([-a-z0-9]*[a-z0-9])?(\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*$` <br /> |
| `backendRefs` _[KafkaBackendRef](#kafkabackendref) array_ |  |  | MaxItems: 16 <br />MinItems: 1 <br /> |
| `filters` _[KafkaRouteFilter](#kafkaroutefilter) array_ |  |  | MaxItems: 16 <br /> |
| `options` _object (keys:[AnnotationKey](#annotationkey), values:[AnnotationValue](#annotationvalue))_ |  |  | MaxProperties: 16 <br /> |
...
| `replicas` _integer_ |  |  |  |
| `strategy` _[DeploymentStrategy](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#deploymentstrategy-v1-apps)_ |  |  |  |
| `template` _[PodTemplateSpec](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#podtemplatespec-v1-core)_ |  |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `licenseRef` _[SecretObjectReference](https://gateway-api.sigs.k8s.io/reference/spec/#secretobjectreference)_ |  |  | Optional: \{\} <br /> |
| `kafka` _[GraviteeKafkaConfig](#graviteekafkaconfig)_ |  | \{ enabled:false \} | Optional: \{\} <br /> |
| `yaml` _[GenericStringMap](#genericstringmap)_ |  |  | Optional: \{\} <br /> |
...
| `bootstrapDomainPattern` _string_ |  | \{apiHost\} | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `deployment` _[Deployment](#deployment)_ |  |  | Optional: \{\} <br /> |
| `service` _[Service](#service)_ |  |  | Optional: \{\} <br /> |
...
| `labels` _object (keys:string, values:string)_ |  |  |  |
| `annotations` _object (keys:string, values:string)_ |  |  |  |
| `type` _[ServiceType](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#servicetype-v1-core)_ |  |  |  |
| `externalTrafficPolicy` _[ServiceExternalTrafficPolicy](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#serviceexternaltrafficpolicy-v1-core)_ |  |  |  |
| `loadBalancerClass` _string_ |  |  |  |
...
| `operations` _[KafkaAccessControlOperation](#kafkaaccesscontroloperation) array_ |  |  | Enum: [Create Read Write Delete Alter AlterConfigs Describe DescribeConfigs ClusterAction] <br /> |
| `match` _[KafkaAccessControlMatch](#kafkaaccesscontrolmatch)_ |  |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `type` _[KafkaAccessControlResourceMatchType](#kafkaaccesscontrolresourcematchtype)_ |  |  | Enum: [Exact Prefix RegularExpression] <br /> |
| `value` _string_ |  |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `type` _[KafkaRouteFilterType](#kafkaroutefiltertype)_ |  |  | Enum: [ACL ExtensionRef] <br /> |
| `acl` _[KafkaAccessControl](#kafkaaccesscontrol) array_ |  |  |  |
