...
| `useHrid` _boolean_ | UseHRID In an ideal world, tests should never use IDs<br />But at the moment it is using IDs to fetch and assert data from<br />management API. So this boolean indicate that when calling the API<br />IDs that are used are HRID. It also means that IDs in the status were generated by Automation API. |  |  |
...
| `use_hrid` _boolean_ | UseHRID In an ideal world, tests should never use IDs<br />But at the moment it is using IDs to fetch and assert data from<br />management API. So this boolean indicate that when calling the API<br />IDs that are used are HRID. It also means that IDs in the status were generated by Automation API. |  |  |
